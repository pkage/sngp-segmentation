...
from sngp_segmentation.train import training_process, fpft_training_process
...
def main():
    ...
    setup()
    state_dict = training_process(args)
    state_dict = fpft_training_process(args, state_dict)
    cleanup()
